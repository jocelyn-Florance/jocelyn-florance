...
Je m'appelle Jocelyn je suis spécialisé dans le développement full-stack (front-end et back-end).

#### Mes compétences sont les suivante :

- Conception et développement du front-end en d'Angular ( 7, 8, 9, 10 )

- Conception et développement du Back-end avec des Frameworks comme (Express, NestJs)

- Gestion d'une base de données avec MongoDB

- Creation d'application avec NuxtJs Server-side rendering (SSR)

- Une très bonne connaissance du Seo et des bonne pratique a appliquer, utilisation d'outil SEMrush

- Intégration d’une maquette Sketch, Figma, Adobe Xd

- La gestion de projet par la méthode agile

- Creation de site wordpress
...
#### Retrouverez mes competence est mes réalisations sur mon site: https://jocelyn-florance.dev/
